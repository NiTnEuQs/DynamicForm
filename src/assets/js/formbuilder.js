...
(function () {
    var BuilderView, EditFieldView, Formbuilder, FormbuilderCollection, FormbuilderModel, ViewFieldView, _ref, _ref1,
        _ref2, _ref3, _ref4,
...
(function () {
    Formbuilder.registerField('meteo', {
        order: 11,
        view: '<% for (i in (rf.get(Formbuilder.options.mappings.OPTIONS) || [])) { %>\n' +
        '  <div>\n    <img src=<%=\'/dynamicform/src/assets/img/animated/\' + rf.get(Formbuilder.options.mappings.OPTIONS)[i].icon %> >     <label class=\'fb-option\'>\n     <input type=\'radio\' <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].checked && \'checked\' %> onclick="javascript: return false;" />\n      <%= rf.get(Formbuilder.options.mappings.OPTIONS)[i].label %>\n    </label>\n  </div>\n<% } %>\n\n<% if (rf.get(Formbuilder.options.mappings.INCLUDE_OTHER)) { %>\n  <div class=\'other-option\'>\n    <label class=\'fb-option\'>\n      <input type=\'radio\' />\n      Autre\n    </label>\n\n    <input type=\'text\' />\n  </div>\n<% } %>\n',
        edit: '',
        addButton: '<span class="symbol"><span class="fa fa-circle-o"></span></span> Question Météo',
        defaultAttributes: function (attrs) {
            attrs.field_options.options = [
                {
                    checked: false,
